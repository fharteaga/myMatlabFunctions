...
% These are the bottom points for each right category,
% with gaps added.
...
% Change it so it "touches the ground":
y2_category_points=y2_category_points-(y2_category_points(1)-y1_category_points(1));
end
