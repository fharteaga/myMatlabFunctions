function [d1km]=lldistkm4(latlon1,latlon2)
% Calcula un vector de distancias  latlon1 Nx2 y latlon2 de Nx2, calculando
% para los pares que están en la misma fila

assert(size(latlon1,2)==2)
assert(size(latlon2,2)==2)

N=size(latlon1,1);
assert(N==size(latlon2,1));
