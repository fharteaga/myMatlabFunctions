...
withExtraWidth=true;
copyToClipboard=false; % Don't set it to true, because if executed from terminal it generates a problem
...
if(copyToClipboard)
    ...
    fprintf('\n\nIf you want it on your clipboard, use the option ''c'',true\n\n')
